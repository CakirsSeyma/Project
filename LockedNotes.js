...
//* getNote ile bütün notları geziyorum ve lockedNotes.html'deki ana div'e ekliyorum. 
...
function getNotes() {
  return JSON.parse(localStorage.getItem("stickynotesNotesLocked") || "[]");
}
//* LocalStorage'e notularımı kaydediyorum.
function saveNotes(notes) {
  localStorage.setItem("stickynotesNotesLocked", JSON.stringify(notes));
}
...
function createNoteElement(id, content) {
  ...
  const storedColors = JSON.parse(localStorage.getItem('stickyNotesColorsLocked')) || {};
...
function changeNoteColor(id, note) {
  ...
  localStorage.setItem('stickyNotesColorsLocked', JSON.stringify(storedColors));
}
